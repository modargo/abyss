...
public class AllIsDustParticleEffect extends AbstractGameEffect {
    ...
    public AllIsDustParticleEffect(float sX, float sY, float tX, float tY, boolean facingLeft) {
        ...
        this.color = new Color(0.02F, 0.0F, 0.6F, 0.6F);
        this.duration = 0.7F;
