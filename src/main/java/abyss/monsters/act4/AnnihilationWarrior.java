...
public class AnnihilationWarrior extends CustomMonster
{
    ...
    private static final int DARK_BARRIER_BLOCK = 20;
    private static final int A8_DARK_BARRIER_BLOCK = 30;
    ...
    private static final int CIRCLE_OF_PROTECTION_BLOCK = 40;
    private static final int A8_CIRCLE_OF_PROTECTION_BLOCK = 50;
    private static final int POLEAXE_DAMAGE = 6;
    private static final int A3_POLEAXE_DAMAGE = 7;
    private static final int POLEAXE_BLOCK = 10;
    private static final int A8_POLEAXE_BLOCK = 15;
