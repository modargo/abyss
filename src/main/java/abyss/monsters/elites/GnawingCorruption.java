...
public class GnawingCorruption extends CustomMonster
{
    ...
    private static final int LEFT_EYE_DAMAGE = 13;
    private static final int A3_LEFT_EYE_DAMAGE = 15;
    private static final int LEFT_EYE_CURSES = 1;
    private static final int A18_LEFT_EYE_CURSES = 2;
    private static final int RIGHT_EYE_DAMAGE = 13;
    private static final int A3_RIGHT_EYE_DAMAGE = 15;
    private static final int RIGHT_EYE_HEAL = 20;
    private static final int A18_RIGHT_EYE_HEAL = 30;
