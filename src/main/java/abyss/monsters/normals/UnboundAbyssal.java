...
import abyss.Abyss;
import abyss.powers.BrokenCrystalSealPower;
...
public class UnboundAbyssal extends CustomMonster {
    public static final String ID = "Abyss:UnboundAbyssal";
    ...
    static {
        ...
        NAME = UnboundAbyssal.monsterStrings.NAME;
        MOVES = UnboundAbyssal.monsterStrings.MOVES;
        DIALOG = UnboundAbyssal.monsterStrings.DIALOG;
    }
}