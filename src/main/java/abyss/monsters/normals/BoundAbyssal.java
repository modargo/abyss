...
public class BoundAbyssal extends CustomMonster {
    ...
    private static final int OBSERVE_DAMAGE = 16;
    private static final int A2_OBSERVE_DAMAGE = 18;
    ...
    private static final int A17_CONTEMPLATE_STRENGTH = 4;
    private static final int CONTEMPLATE_BUFFER = 1;
    private static final int A17_CONTEMPLATE_BUFFER = 2;
    private static final int CONTEMPLATE_ARTIFACT = 1;
    private static final int A17_CONTEMPLATE_ARTIFACT = 2;
    private static final int SCRUTINIZE_DAMAGE = 11;
    private static final int A2_SCRUTINIZE_DAMAGE = 13;
